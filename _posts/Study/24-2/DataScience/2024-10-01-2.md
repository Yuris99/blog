...
![](asset/imgs/DS/Sensitivity_and_specificity_1.png)    
왼쪽: positive samples      
...
![variable of sum of two dice](/asset/imgs/DS/PDFs.png)    
...
![bin size가 클 때, bin size가 작을 때](/asset/imgs/DS/Histogram_binsize.png)      
분포를 표현하는 데에 영향을 끼침    
